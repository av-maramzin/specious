...
macro(PParMetricsPipelineSetupNames)
    set(PIPELINE_NAME "PParMetrics")
    set(PIPELINE_INSTALL_TARGET "${PIPELINE_NAME}-install")
endmacro()

macro(PParMetricsPipelineSetup)
    PParMetricsPipelineSetupNames()
    message(STATUS "setting up pipeline ${PIPELINE_NAME}")
endmacro()

PParMetricsPipelineSetup()

function(PParMetricsPipeline trgt)
    PParMetricsPipelineSetupNames()
    ...
    add_custom_target(${PIPELINE_SUBTARGET} DEPENDS
        ${PIPELINE_PREFIX}_bc
        ${PIPELINE_PREFIX}_pdg
        ${PIPELINE_PREFIX}_metrics
